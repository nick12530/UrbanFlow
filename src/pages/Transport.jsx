...
const services = {
  ...
  entertainment: [
    ...
    },
    {
      ...
      reviews: 234,
      contact: "0722666777",
      facilities: ["Cinema", "Ice Rink", "Restaurants", "Shops", "Adventure Park"],
      openingHours: "8:00 AM - 11:00 PM",
      parking: "Available (Ksh 150 first 2 hours)",
      popularStores: ["Nakumatt", "Java House", "KFC", "Pizza Hut"],
      events: ["Ice skating shows", "Food festivals", "Kids workshops"],
      accessibility: ["Wheelchair access", "Elevators", "Family restrooms"]
    },
    {
      id: 404,
      ...
      reviews: 189,
      contact: "0722777888",
      facilities: ["Cinema", "Restaurants", "Shops", "Gym", "Banking"],
      openingHours: "9:00 AM - 10:00 PM",
      parking: "Available (Ksh 200 first 3 hours)",
      popularStores: ["Nakumatt", "Java House", "Artcaffe", "Adidas"],
      events: ["Fashion shows", "Food festivals", "Live performances"],
      accessibility: ["Wheelchair access", "Elevators", "Family restrooms"]
    },
    {
      id: 405,
      ...
      reviews: 145,
      contact: "0722888999",
      facilities: ["Restaurants", "Shops", "Banking", "Office spaces"],
      openingHours: "8:00 AM - 9:00 PM",
      parking: "Available (Ksh 100 first 2 hours)",
      popularStores: ["Nakumatt", "Java House", "KFC", "Banks"],
      events: ["Business networking", "Food festivals"],
    ...
    },
    {
      ...
      icon: <MdShoppingCart size={20} />,
      image: SERVICE_IMAGES.mall,
      location: [-1.306, 36.807],
      rating: 4.6,
      reviews: 267,
      contact: "0722999000",
      facilities: ["Cinema", "Restaurants", "Shops", "Swimming Pool", "Gym"],
      openingHours: "9:00 AM - 10:00 PM",
      parking: "Available (Ksh 250 first 3 hours)",
      popularStores: ["Carrefour", "Java House", "Artcaffe", "Sports stores"],
      events: ["Swimming competitions", "Food festivals", "Fashion shows"],
      accessibility: ["Wheelchair access", "Elevators", "Family restrooms"]
    },
    {
      id: 407,
      ...
      parking: "Available (Ksh 150 first 2 hours)",
      popularStores: ["Nakumatt", "Java House", "KFC", "Banks"],
      events: ["Business events", "Food festivals"],
      accessibility: ["Wheelchair access", "Elevators"]
    },
    {
      id: 408,
      ...
      icon: <MdShoppingCart size={20} />,
      image: SERVICE_IMAGES.mall,
      location: [-1.286, 36.857],
      rating: 3.8,
      reviews: 89,
      contact: "0722111222",
      facilities: ["Restaurants", "Shops", "Banking"],
      openingHours: "8:00 AM - 8:00 PM",
      parking: "Available (Ksh 100 first 2 hours)",
      popularStores: ["Nakumatt", "Java House", "Local shops"],
      events: ["Community events", "Food festivals"],
  ...
  education: [
    {
      ...
      type: "university",
      icon: <FaUniversity size={20} />,
      image: SERVICE_IMAGES.hospital, // Using hospital image as placeholder
      location: [-1.286, 36.817],
      rating: 4.5,
      reviews: 456,
      contact: "0722333444",
      programs: ["Engineering", "Medicine", "Law", "Business", "Arts"],
      admissionRequirements: ["KCSE B+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Hostels", "Cafeteria"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Career services"],
      transport: ["Bus routes 111, 112", "Matatu routes 15, 16", "Walking distance from CBD"]
    },
    {
      id: 502,
      ...
      icon: <FaUniversity size={20} />,
      image: SERVICE_IMAGES.hospital,
      location: [-1.176, 36.927],
      rating: 4.3,
      reviews: 389,
      contact: "0722444555",
      programs: ["Education", "Medicine", "Engineering", "Agriculture", "Arts"],
      admissionRequirements: ["KCSE B+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Hostels", "Cafeteria"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Career services"],
      transport: ["Bus routes 1, 2", "Matatu routes 32, 33", "Shuttle services"]
    },
    {
      id: 503,
      ...
      icon: <FaUniversity size={20} />,
      image: SERVICE_IMAGES.hospital,
      location: [-1.096, 37.017],
      rating: 4.4,
      reviews: 312,
      contact: "0722555666",
      programs: ["Engineering", "Technology", "Business", "Agriculture"],
      admissionRequirements: ["KCSE B+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Hostels", "Cafeteria"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Career services"],
      transport: ["Bus routes 3, 4", "Matatu routes 34, 35", "Shuttle services"]
    },
    {
      id: 504,
      ...
      reviews: 234,
      contact: "0722666777",
      programs: ["Business", "Law", "IT", "Arts", "Medicine"],
      admissionRequirements: ["KCSE B+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Cafeteria", "Modern facilities"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Career services"],
      transport: ["Bus routes 111, 112", "Matatu routes 24, 25", "Walking distance from Karen"]
    },
    {
      id: 505,
      ...
      reviews: 198,
      contact: "0722777888",
      programs: ["Business", "Psychology", "IT", "Arts", "International Relations"],
      admissionRequirements: ["KCSE B+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Cafeteria", "Modern facilities"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Career services"],
      transport: ["Bus routes 111, 112", "Matatu routes 24, 25", "Walking distance from Karen"]
    },
    {
      ...
      reviews: 167,
      contact: "0722888999",
      programs: ["Communication", "Business", "Arts", "Theology"],
      admissionRequirements: ["KCSE B+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Cafeteria", "Chapel"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Spiritual activities"],
      transport: ["Bus routes 111, 112", "Matatu routes 24, 25", "Walking distance from Karen"]
    },
    {
      id: 507,
      ...
      reviews: 145,
      contact: "0722999000",
      programs: ["Theology", "Business", "Arts", "Education"],
      admissionRequirements: ["KCSE B+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Cafeteria", "Chapel"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Spiritual activities"],
      transport: ["Bus routes 111, 112", "Matatu routes 24, 25", "Walking distance from Westlands"]
    },
    {
      id: 508,
      ...
      reviews: 223,
      contact: "0722000111",
      programs: ["Engineering", "Technology", "Architecture", "Applied Sciences"],
      admissionRequirements: ["KCSE B+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Workshops", "Cafeteria"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Career services"],
      transport: ["Bus routes 111, 112", "Matatu routes 15, 16", "Walking distance from CBD"]
    }
  ],
  schools: [
    {
      ...
      reviews: 234,
      contact: "0722111222",
      programs: ["Form 1-4", "A-Level", "IB Diploma"],
      admissionRequirements: ["KCPE 350+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Boarding", "Cafeteria"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Leadership training"],
      transport: ["Bus routes 111, 112", "Matatu routes 24, 25", "School buses"]
    },
    {
      id: 602,
      ...
      reviews: 189,
      contact: "0722222333",
      programs: ["Form 1-4", "A-Level"],
      admissionRequirements: ["KCPE 350+", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Boarding", "Cafeteria"],
      studentLife: ["Clubs", "Sports", "Cultural events", "Leadership training"],
      transport: ["Bus routes 111, 112", "Matatu routes 15, 16", "School buses"]
    },
    {
      id: 603,
    ...
    },
    {
      ...
      reviews: 123,
      contact: "0722555666",
      programs: ["IGCSE", "A-Level", "IB Diploma"],
      admissionRequirements: ["Previous school records", "Application form", "Interview"],
      facilities: ["Library", "Sports complex", "Boarding", "Cafeteria"],
      studentLife: ["Clubs", "Sports", "Cultural events", "International programs"],
      transport: ["Bus routes 111, 112", "Matatu routes 24, 25", "School buses"]
    },
    {
      id: 606,
